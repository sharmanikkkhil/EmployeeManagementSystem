...
public class Employee {
    ...
    public Employee(Long id, String employeeCode, String fullName, String companyEmail, String password, String role,
			...
			String ifscCode, LocalDate payDate, String basicSalary, String incentive, String houseRentAllowance,
			String totalEarnings, String providentFund, String professionalTax, String totalDeductions, String netPay,
	...
	public String toString() {
		return "Employee [id=" + id + ", employeeCode=" + employeeCode + ", fullName=" + fullName + ", companyEmail="
				...
				+ ", ifscCode=" + ifscCode + ", payDate=" + payDate + ", basicSalary="
				+ basicSalary + ", incentive=" + incentive + ", houseRentAllowance=" + houseRentAllowance
				+ ", totalEarnings=" + totalEarnings + ", providentFund=" + providentFund + ", professionalTax="
				+ professionalTax + ", totalDeductions=" + totalDeductions + ", netPay=" + netPay + ", netPayInWords="
				+ netPayInWords + "]";
	}
