...
public class EmployeeController {
	...
	public String employeeDashboard(Principal principal, Model model) {
	   ...
	   @GetMapping("/payslip")
	    public String employeePayslip(Principal principal, Model model) {
	        // Assuming principal.getName() returns the employee code
	        String employeeCode = principal.getName();
	        ...
	        // Add employee to model so the payslip page can use it
	        model.addAttribute("employee", employee);
	        return "payslip"; // Return the view name for payslip
	    }
