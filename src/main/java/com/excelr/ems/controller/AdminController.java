...
public class AdminController {
    ...
    public String updateEmployee(@PathVariable String employeeCode, 
        ...
        existingEmployee.setPayDate(employee.getPayDate());
        existingEmployee.setBasicSalary(employee.getBasicSalary());
        existingEmployee.setIncentive(employee.getIncentive());
        existingEmployee.setHouseRentAllowance(employee.getHouseRentAllowance());
        existingEmployee.setTotalEarnings(employee.getTotalEarnings());
        existingEmployee.setProvidentFund(employee.getProvidentFund());
        existingEmployee.setProfessionalTax(employee.getProfessionalTax());
        existingEmployee.setTotalDeductions(employee.getTotalDeductions());
        existingEmployee.setNetPay(employee.getNetPay());
        existingEmployee.setNetPayInWords(employee.getNetPayInWords());
